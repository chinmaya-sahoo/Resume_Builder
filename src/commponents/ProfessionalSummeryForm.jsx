  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 px-3 py-2 text-sm bg-purple-50 text-purple-600 hover:bg-purple-200 rounded  transition-colors disabled:opacity-50">
