...
function Testimonials() {
  ...
  return (
    <div id='tesimonials' className='flex flex-col items-center mb-19 scroll-mt-12'>
        <div className="flex items-center gap-2 text-sm text-green-700 bg-green-400/10 rounded-full px-4 py-1">
            <BookUserIcon className='size-4.5 stroke-green-500' />
            <span>Testimonials</span>
        </div>
        <Title
         title="Don't just take our word for it"
         description="See what our satisfied users have to say about ResumePro and how it has transformed their job search experience."
        />
