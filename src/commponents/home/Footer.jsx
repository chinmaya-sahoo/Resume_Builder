...
function Footer() {
  return (
    <div>
      ...
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 mt-20
      bg-gradient-to-r from-white via-green-200/60 to-white">
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
          ...
          <div>
            <p className="text-slate-600 font-semibold">Resources</p>
            <ul className="mt-2 space-y-2">
              <li>
                <a href="/" className="hover:text-green-600 transition">
                  Company
          ...
          <div>
            <p className="text-slate-600 font-semibold">Legal</p>
            <ul className="mt-2 space-y-2">
              <li>
                <a href="/" className="hover:text-green-600 transition">
                  Privacy
