...
const Dashboard = () => {
  const colors = ["#34D399", "#8B5CF6", "#3B82F6", "#F59E0B", "#EF4444"];
  ...
  const deleteTitle = async (resumeId) => {
            ...
            return (
              ...
              >
                ...
                <div onClick={e=>e.stopPropagation()} className="absolute top-1 right-1 group-hover:flex items-center hidden">
                  <TrashIcon onClick={()=>deleteTitle(resume._id)} className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors" />
                  <PencilIcon
                    onClick={() => {
